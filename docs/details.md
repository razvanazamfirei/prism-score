...
``` stata
**prismscore** [**new\_varlist**](#new_varlist) \[[if]\] \[[in]\] , [prismIII\_varlist](#p3v) \[**prism4** [prismIV\_varlist](#p4v)\] \[unit\_options\] \[debugging\_options\]
```
...
## Variable Lists and Options (overview)
...
| Option Name   | Option Description|
|-------------  | -------------     |
| ph(varname)   | pH variable; if *phhigh* is used, then *ph* designates the low pH variable| |
| bicarb(varname) | designates the bicarbonate variable. if *bicarbhigh* is used, then it designates the low bicarbonate variable |
| pco2(varname) | PCO2 variable |
| pao2(varname) | PaO2 variable |

Optional
| Option Name   | Option Description------------- | ------------- |
| phhigh(varname) pH variable; if *phhigh* is used, then *ph* designates the low pH variable.
